...
def summary(model, input, depth=1, device="cpu"):
    ...
    except Exception as exc:  # torchinfo may fail on some dynamic modules
        print(f"[summary] torchinfo failed: {exc}")
        print("[summary] Skipping model summary for this run.")
    print("=" * 80)
    print()
